...
import ShowExploracion from "./components/exploraciones/ShowExploracion";
//Excavaciones
...
import ShowExcavacion from "./components/excavaciones/ShowExcavacion";
...
//Denuncia
import Denuncias from "./components/denuncias/MainDenuncias";
import AddDenuncia from "./components/denuncias/AddDenuncia";
import EditDenuncia from "./components/denuncias/EditDenuncia";
import ShowDenuncia from "./components/denuncias/ShowDenuncia";
    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route path="/showExploracion/:id" component={ShowExploracion} />{" "}
          ...
          <Route path="/showExcavacion/:id" component={ShowExcavacion} />{" "}
          ...
          <Route path="/addDenuncia" component={AddDenuncia} />{" "}
          <Route path="/Denuncias" component={Denuncias} />{" "}
          <Route path="/editDenuncia/:id" component={EditDenuncia} />{" "}
          <Route path="/showDenuncia/:id" component={ShowDenuncia} />{" "}
          <Route path ="/prestamos" component = { Prestamos }/> 
          <Route path = "/addPrestamo" component = { AddPrestamo }/> 
          <Route path = "/editPrestamo/:id" component = { EditPrestamo }/>
          <Route path = "/showPrestamo/:id" component = { ShowPrestamo }/>
          <Route path = "/exhibiciones" component = { Exhibiciones }/>
          <Route path = "/addExhibicion" component = { AddExhibicion }/>
          <Route path = "/editExhibicion/:id" component = { EditExhibicion }/>
          <Route path = "/showExhibicion/:id" component = { ShowExhibicion }/>
          <Route path = "/replicas" component = { Replicas }/>
          <Route path = "/addReplica" component = { AddReplica }/>
          <Route path = "/editReplica/:id" component = { EditReplica }/>
          <Route path = "/showReplica/:id" component = { ShowReplica }/>
          <Route path = "/donaciones" component = { Donaciones }/>
          <Route path = "/addDonaciones" component = { AddDonaciones }/>
          <Route path = "/editDonaciones/:id" component = { EditDonaciones }/>
          <Route path = "/showDonaciones/:id" component = { ShowDonaciones }/>
