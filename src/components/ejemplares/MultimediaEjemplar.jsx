...
componentDidMount() {
  ...
  else
  {
    ...
    .then((response) => {
      ...
      .then((ejemplars) => {
		  rutaFile='/assets/datos/ejemplares/'+this.props.match.params.id;
          idEj= this.props.match.params.id
  ...
  handleImagenSubmit = event => {
    ...
    if (nombre && descripcion) {
      ...
      //subir archivo(IMAGEN) al server 
      //------------------------------------------------------------------------------------------------
        const destino= "/var/www/consulta/html/assets/datos/ejemplares/"+this.props.match.params.id
      ...
      //------------------------------------------------------------------------------------------------
        //ACTUALIZO TABLA EJEMPLARES (ARRAY FOTOS)
		
		var imagenesList= this.state.imagenes
		var imageURL="/assets/datos/ejemplares/"+this.props.match.params.id;
 ...
 render() 
 {
                            ...
                            <table className="table table-bordered table-hover list">
                              ...
                              <tbody>
                                  ...
                                  {listImagen.map(item => (
                                      ...
                                      <td>
                                        <button id="elimImagen" type="button" onClick={()=>this.deleteFile(item._id, item.nombre)} title="Eliminar Imagen" className="btn btn-outline-danger my-2 my-sm-0"><span className="fa fa-trash" title="Eliminar"></span></button>
                                        &nbsp;&nbsp;
                                        ...
                                        <div id={"myModal"+i} className="modal fade" role="dialog">  
                                          <div className="modal-dialog ">
                                              <div className="modal-content">      
                                                  ...
                                                  <div className="modal-body"><img src={urlPage+rutaFile+item.nombre} className="img-rounded" alt="Foto" width="400" height="400" />   </div>      
                              ...
                              <tbody>
                                  ...
                                  {listVideo.map(item => (
                                      <tr key={j}>
                                        ...
                                        <td>
                                        <button  id="elimVideo" type="button" onClick={()=>this.deleteVideo(idEj,item.replace("C:\\fakepath\\", "\\").replace(/\s+/g,"_"))} title="Eliminar Video" className="btn btn-outline-danger my-2 my-sm-0"><span className="fa fa-trash" title="Eliminar"></span></button>
											{/* &nbsp;&nbsp;
                                            ...
                                            <div className="modal-dialog modal-lg" >
                                                <div className="modal-content" >      
                                                    ...
                                                    <div className="modal-body">
                                                      ...
                                                      <video id={"myVideo"+j} src={rutaFile+item} width="640" height="360" controls preload="auto"> </video>  
   ...
   deleteVideo(id, nombre)
   {
	...
	{  
      ...
      var name=nombre.replace("\\","/")
        ...
        axios.get("http://museo.fi.uncoma.edu.ar:3006/api/ejemplarId/"+id)
        .then(response => {
                      ...
                      axios.put("http://museo.fi.uncoma.edu.ar:3006/api/ejemplar/"+idEjemplar, data1, {
                        headers:{
                          'Content-Type': 'application/json'
                        }   
                      }).then(response => {
    
                             const destino="/var/www/consulta/html/assets/datos/ejemplares/"+idEjemplar+name
   ...
   deleteFile(cod, name) {
    if(window.confirm('Esta seguro de eliminar la imagen seleccioanada?'))
	{
        ...
        axios.get("http://museo.fi.uncoma.edu.ar:3006/api/ejemplarPorFoto/"+cod)
        .then(response => {
