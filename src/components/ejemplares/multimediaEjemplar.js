...
componentDidMount() {
    ...
    .then((response) => {
      ...
      .then((ejemplars) => {
		  rutaFile='/images/ejemplares/'+this.props.match.params.id;
  ...
  handleImagenSubmit = event => {
    ...
    if (nombre && descripcion) {
      ...
      //------------------------------------------------------------------------------------------------
		...
		var imageURL="/images/ejemplares/"+this.props.match.params.id;
                                        ...
                                        <div id={"myModal"+i} className="modal fade" role="dialog">  
                                          <div className="modal-dialog ">
                                              <div className="modal-content">      
                                                  ...
                                                  <div className="modal-body"><img src={rutaFile+item.nombre} className="img-rounded" alt="Foto" width="400" height="400" />   </div>      
                      ...
                      axios.put("/api/ejemplar/"+idEjemplar, data1, {
                        headers:{
                          'Content-Type': 'application/json'
                             ...
                             const destino="./../museo-administracion/public/images/ejemplares/"+idEjemplar+name
