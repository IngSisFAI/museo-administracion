...
class EditUsuario extends React.Component {
    ...
    componentDidMount(){
        ...
        {
            axios.get('http://museo.fi.uncoma.edu.ar:3006/api/getUsuario', {params: {"user": cookies.get('user'), "password":cookies.get('password'), "id":this.props.match.params.id}})
            .then(res => {
                  return res.data
            })
          .then(
            (result) => {
                  ...
                  this.setState({ nombre:result.usuarioId.nombre,
