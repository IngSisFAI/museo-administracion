         ...
         return( 
            ...
            <Form.Row>
                 <div id="contenido" align="left" className="container">
                    ...
                    <legend> <FontAwesomeIcon icon={faMapMarked} /> Gestión de Exploraciones</legend>
                    <hr/>  
                      ...
                      title="Listado"
                       columns={ [
                        ...
                        ,
                        {
                          ...
                          field: 'fecha',
                          type: "date",
                          render: rowData => (Moment(rowData.fecha).add(1, 'days')).format('DD/MM/YYYY')
                        }
                      ]}
                       ...
                       actions={[
                        {
                          ...
                          onClick: (event, rowData) => {
						                   this.props.history.push(`/editExploracion/${rowData._id}`); ;
