...
class AddDenuncia extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      denunciante: "",
  ...
  setIdArea = (idArea) => this.setState({ idArea });
          ...
          <div className="col-md-12">
            <div id="contenido" align="left" className="container">
              <h3 className="page-header" align="left">
                <FontAwesomeIcon icon={faHandshake} /> Nueva Denuncia
              </h3>
              <Tabs
                id="tabDonacion"
                  ...
                  >
                    ...
                    <Form.Row>
                      <Form.Group className="col-sm-12">
                        <CrearExploracion setAreaId={this.setIdArea} />
                      </Form.Group>
                    </Form.Row>
                  </Form>
...
export default withRouter(AddDenuncia);
