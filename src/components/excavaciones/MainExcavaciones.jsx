        ...
        .then(function(response) {
          if (response.ok) {
            console.log("¡Se eliminó la Excavación con Éxito!");
                        ...
                        const destino="/var/www/museo-administracion/html/images/excavaciones/"+id+"/";
        ...
        return (
            ...
            <Form.Row>
                 <div id="contenido" align="left" className="container">
                    ...
                    <legend> <FontAwesomeIcon icon={faCompass} /> Gestión de Excavaciones</legend>
                    <hr/>  
                      ...
                      title="Listado"
                       columns={ [
                        ...
                        },
                        {
                          ...
                          field: 'fechaInicio',
                          type: "date", 
                          render: rowData => (Moment(rowData.fechaInicio).add(1, 'days')).format('DD/MM/YYYY')
                        },
                        {
                          title: 'Director',
                          field: 'director',
                       ...
                       actions={[
                        ...
                        },
                        {
                          ...
                          onClick: (event, rowData) => {
                            // Do save operation
                            if( window.confirm('¿Está seguro de eliminar la Exploración seleccionada?'))
                            {
