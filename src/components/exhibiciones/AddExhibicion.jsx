...
import { faSave, faDiagnoses, faTrash, faTimesCircle, faUpload } from '@fortawesome/free-solid-svg-icons'
...
class AddExhibicion extends React.Component {
  ...
  handleBlur = evt => {
    fetch(urlApi + "/donacionNro/" + evt.target.value, {
      ...
      .then(result => {
        ...
        console.log("Error al consultar las exhibiciones:", error)
      });
  };
  handleSubmit = (event) => {  
    ...
    if (form.checkValidity() === false) {
      ...
      if (op === 'I') {
        ...
        fetch(urlApi + "/exhibicion", {
          ...
          if (response.ok) {
            console.log("¡Se guardó la Exhibición con Éxito!");
            return response.json();
          }
        }).then(function (data) {
          $(".loader").fadeOut("slow");
          toast.success("¡Se guardó la Exhibición con Éxito!");
          this.setState({ idExhibicion: data.exhibicion._id, op: 'U' });
        ...
        fetch(urlApi + '/exhibicion/' + this.state.idExhibicion, {
          method: 'put',
          body: JSON.stringify(data),
          headers: {
            'Content-Type': 'application/json',
          ...
          .then(function (response) {
            $(".loader").fadeOut("slow");
            if (response.ok) {
              toast.success("¡Se actualizaron los datos de la Exhibición con Éxito!");
              ...
              if (response.ok) {
                ...
                axios.post(urlApi + "/uploadArchivo", data, {
                  ...
                  .then(response => {
                    ...
                    setTimeout(() => {
                      this.setState({ showSuccesscv: false, showErrordoc: false });
                    }, 2500);
                  })
                  .catch(error => {
                    $(".loader").fadeOut("slow");  
          ...
          <div className="col-md-12">
            <div id="contenido" align="left" className="container">
              ...
              <h3 className="page-header" align="left">
                <FontAwesomeIcon icon={faDiagnoses} /> Nueva Exhibición
              </h3>
              <hr />
              <ToastContainer
                position="top-right"
...
export default withRouter(AddExhibicion);