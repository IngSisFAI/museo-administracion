...
export default class ObtenerExcavacion extends Component {
    ...
    componentDidMount() {
        ...
        //L.tileLayer("http://{s}.tile.opentopomap.org/{z}/{x}/{y}.png").addTo(map);
        L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(map);
        //L.tileLayer("https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/").addTo(map);
        //L.tileLayer("https://wayback.maptiles.arcgis.com/arcgis/rest/services/World_Imagery/WMTS/1.0.0/default028mm/MapServer/tile/42403/{z}/{x}/{y}.png").addTo(map);
        this.setState({ map });
        //let marker = L.marker([-38.9517, -68.0592]).addTo(map);
    ...
    perteneceAlgunArea = (datosAreas, punto) => {
       ...
       this.state.exploraciones.forEach((area) => { 
            ...
            exploracionesCompletas.forEach((exploracionCompleta) => {
                ...
                const datosExploracion = {
                    ...
                    ciudad: exploracionCompleta.areaExploracion ?
                        exploracionCompleta.areaExploracion.ciudad : "Neuquen",
                    provincia: exploracionCompleta.areaExploracion ?
                        exploracionCompleta.areaExploracion.provincia : "Neuquen",
                    pais: exploracionCompleta.areaExploracion ?
                        exploracionCompleta.areaExploracion.pais : "Argentina",
    ...
    render() {
        return ( <
            ...
            />
            Capas de Exploracion </label>

            <
            label >
            <
            input name = "capasExcavacion"
            type = "checkbox"
            ...
            />
            Capas de Excavacion < /label>

            <
            label >
            <
            input name = "capasPuntosGps"
            type = "checkbox"
