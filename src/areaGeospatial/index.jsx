        ...
        <div className="row" style={{ marginTop: 25 }}>
          <div className="col-md-2">
            <button
              ...
              onClick={this.obtenerExploraciones}
            >
          ...
          <div className="col-md-2">
            <button
              className="btn btn-outline-primary"
              onClick={this.modificarExcavacion}
            >
          ...
          <div className="col-md-2">
            <button
              className="btn btn-outline-primary"
              onClick={this.modificarExploracion}
            >
